...
\author{Dominic Baril$^{1}$, Philippe Gigu�?re$^{1}$, François Pomerleau$^{1}$  %\\
	...
	\thanks{$^{1}$ The authors are with Northern Robotics Laboratory, Université Laval, Québec City, Canada,
		{\tt{\small{$\{$dominic.baril, francois.pomerleau$\}$ @norlab.ulaval.ca,} philippe.giguere@ift.ulaval.ca}}}%
	\thanks{* This research was supported by the Natural Sciences and Engineering Research Council of Canada (NSERC) through the grant }%
}
